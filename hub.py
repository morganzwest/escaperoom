...
try:
    ...
    try:
        ...
        try:
            ...
            raise ModuleNotFoundError("Python is not installed correctly. Please reinstall with Python added to path with Pip.")

    except:
        raise EnvironmentError("Python is not installed correctly. Please reinstall with Python added to path with Pip.")
